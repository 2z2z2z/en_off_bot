...
- Запрашивать ревью изменений. По возможности устранять замечания ревью (включая те, что не блокируют).
...
- [ ] **Фаза 1: Архитектурная сетка и декомпозиция точки входа** (см. [раздел 3.1](refactoring.md#31-декомпозиция-точки-входа))
